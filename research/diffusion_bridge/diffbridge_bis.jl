...
α = 1.5
# Number of levels of FS basis functions (level == first index)
L = 7
#Length diffusion brifges
T = 50.0
# Drift
b(x) = α * sin(x)
# First derivative
...
T′ = 1000.0 # final clock of the pdmp
...
trace, (t, ξ, θ), num, c = @time spdmp(∇ϕmoving, 0.0, ξ0, θ0, T′, c, ZigZag(Γ, ξ0 * 0),
