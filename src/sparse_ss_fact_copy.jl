...
function sparse_sspdmp_inner!(Ξ, G, G1, G2, ∇ϕ, t, x::SparseVector{Float64, Int64}, θ, Q, c, b, t_old, f, θf, s, ns, (acc, num),
...
function sparse_sspdmp(∇ϕ, t0, x0::SparseVector{Float64, Int64}, θ0, θf, T, c, G, F::ZigZag, κ::Float64, args...; reversible=false,strong_upperbounds = false,
    ...
    tstop = T/stops
    while t′ < T
        t, x, θ, t′, s, ns, (acc, num), c,  b, t_old = sparse_sspdmp_inner!(Ξ, G, G1, G2, ∇ϕ, t, x, θ, Q,
